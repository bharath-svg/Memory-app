...
export const updatePost = async (req , res) => {
    ...
    if(!mongoose.Types.ObjectId.isValid(_id)) return res.status(404).send('id is not valid');
...
export const likePost = async (req , res) => {
    ...
    if(!mongoose.Types.ObjectId.isValid(id)) return res.status(404).send("id not valid");
